                    ...
                    <form:form action="addComputer" method="POST" id="formComputer" modelAttribute="computerDTO">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <form:input type="date" class="form-control" id="introduced" name="introduced" path="introduced" placeholder="${mess_introduced}"/>
                                <form:errors path="introduced" cssClass="error"/>
                            </div>
                            <div class="form-group">
                            	<spring:message code="label.discontinued" var="mess_discontinued"/>
                                <label for="discontinued">${mess_discontinued}</label>
                                <form:input type="date" class="form-control" id="discontinued" name="discontinued" path="discontinued" placeholder="${mess_discontinued}"/>
