...
<c:set var="forSearch" value="page=${page}&nbComputersPage=${nbComputersPage}&column=${column}&order=${order}&search=${search}"/>
<c:set var="notSearch" value="page=${page}&nbComputersPage=${nbComputersPage}&column=${column}&order=${order}" />
